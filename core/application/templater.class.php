...
class OPAL_Templater
{
	...
	{
		echo OPAL_Lang::t($key, $array_key);
	}
	...
	public function getDate($date)
	{
		...
		return date(OPAL_Portal::config('system_date_format', 'd.m.Y'), $date);
	}
	...
	public function getTime($time)
	{
		...
		return date(OPAL_Portal::config('system_time_format', 'd.m.Y H:i:s'), $time);
	}
