	...
	private function createContent()
	{
		...
		$content_data = array(
			array(
				...
				'content_status' => 7,
				'content_commands' => array(array('module' => 'system', 'controller' => 'text', 'method' => 'index', 'static' => false, 'args' => []),),
			...
			array(
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'text', 'method' => 'index', 'static' => true, 'args' => []),),
				'content_template' => 'block-element.phtml',
			),
			array(
				'content_type' => 'block',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'system', 'method' => 'langswitcher', 'static' => true, 'args' => []),),
				'content_template' => 'block-element.phtml',
			),
			array(
				'content_type' => 'block',
			...
			array(
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'search', 'method' => 'form', 'static' => true, 'args' => []),),
				'content_template' => 'block-element.phtml',
			),
			array(
				'content_type' => 'block',
			...
			array(
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'error', 'method' => 'unauthorized', 'static' => false, 'args' => []),),
			...
			array(
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'error', 'method' => 'notfound', 'static' => false, 'args' => []),),
				'content_template' => 'main-error.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 7,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-center', 'method' => '', 'static' => false, 'args' => []),
				),
			...
			array(
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-media', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-pages', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-blocks', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-types', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-options', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-users', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-log', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-cache', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-sitemap', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-content', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-admin', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-modules', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-groups', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-privileges', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
			array(
				'content_type' => 'admin',
				...
				'content_on_site_mode' => 0,
				'content_status' => 6,
				'content_commands' => array(array('module' => 'system', 'controller' => 'admin-files', 'method' => '', 'static' => false, 'args' => []),),
				'content_template' => 'main-admin.phtml',
			),
		);
